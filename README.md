The GitHub repository https://github.com/sharmi25208/NMproject/blob/main/README.md hosts a Python-based application designed to facilitate voice-based speech search engine.
🔍 Project Overview
